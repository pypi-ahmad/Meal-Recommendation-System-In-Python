...
df = pd.read_csv(r'D:\Personalized_meal_recommendation_system-master\DJANGO\minor\website\dataset.csv')
...
def Recommend(request):
    ...
    if request.user.is_authenticated:
        class Recommender:
            ...
            def __init__(self):
                self.df = pd.read_csv(r'D:\Personalized_meal_recommendation_system-master\DJANGO\minor\website\dataset.csv')
