...
def buy(request):
    ...
    filename=r"D:\Personalized_meal_recommendation_system-master\DJANGO\minor\website\csvfile\recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        filename=r"D:\Personalized_meal_recommendation_system-master\DJANGO\minor\website\csvfile\recent_activity.csv"
        filename2=r"D:\Personalized_meal_recommendation_system-master\DJANGO\minor\website\dataset.csv"
