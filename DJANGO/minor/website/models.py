...
class Profile(models.Model):
    ...
    image=models.ImageField(upload_to='website/images',default=r"D:\Personalized_meal_recommendation_system-master\DJANGO\minor\media\website\images\avtar.png")
